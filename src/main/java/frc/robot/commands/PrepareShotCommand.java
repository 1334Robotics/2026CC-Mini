...
public class PrepareShotCommand extends Command {
    ...
    static {
        // Feels like something that should be tagged
        ...
        distanceToShotMap.put(Meters.of(1.46), new Shot(4500, 0.77));
        distanceToShotMap.put(Meters.of(6.8), new Shot(4500, 0.01));
    }
